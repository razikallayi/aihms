...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	...
	<div class="card">
		<div class="body">
			...
			<form id="form_validation" method="POST" action="{{url('admin/add-product-category')}}" enctype="multipart/form-data">
				{{csrf_field()}}
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="text" name="productcategory" maxlength="80" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group">
							...
							<p class="help-block">Use dark image of width atleast 950px for a better visual appeal</p>
							...
							<div id="result" class="img-preview preview-lg row"></div>
						</div>
					</div>
				</div>
