...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	<div class="card">
		<div class="body">
			...
			<form id="form_validation" method="POST" action="{{url('admin/talks')}}" enctype="multipart/form-data">
				{{csrf_field()}}
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						...
						<div class="form-group ">
							<div class="form-line">
								<input onchange="loadVideo(this.value)" type="url" value="{{old('url')}}" name="url"  class="form-control" required placeholder="eg:https://www.youtube.com/watch?v=y_zav986tHc">
							</div>
						</div>
					</div>
					<div id="videoResult" class="col-md-3"></div>
				</div>
