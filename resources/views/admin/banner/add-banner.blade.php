			...
			<form id="form_validation" method="POST" action="{{url('admin/banners')}}" enctype="multipart/form-data">
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="text" value="{{old('title_small')}}" name="title_small" maxlength="50" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group">
							<div class="form-line">
								<textarea name="description" maxlength="50" class="form-control" required>{{old('description')}}</textarea>
							</div>
						</div>
					</div>
				</div>
...
<script>
	$(function() {
		var imageWidth = 1170;
		var imageHeight = 509;
		var storageLocation= "{{App\Models\Banner::IMAGE_LOCATION}}";
		var postUrl = "{{url('admin/banner/upload-image')}}";
